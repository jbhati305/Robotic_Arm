...
static const _MyMessage_type_support_symbol_names_t _MyMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msg_package, msg, MyMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_msg_package, msg, MyMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_msg_package, msg, MyMessage)() {
  return &::my_msg_package::msg::rosidl_typesupport_c::MyMessage_message_type_support_handle;
}
