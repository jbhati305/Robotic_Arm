...
#include "my_msg_package/msg/detail/my_message__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msg_package::msg::MyMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_msg_package::msg::MyMessage *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_msg_package::msg::MyMessage *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_my_msg_package
const rosidl_message_type_support_t *
get_message_type_support_handle<my_msg_package::msg::MyMessage>()
{
  return &my_msg_package::msg::typesupport_fastrtps_cpp::_MyMessage__handle;
}
